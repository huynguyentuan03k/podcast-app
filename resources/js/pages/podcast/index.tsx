...
const columns: ColumnDef<Podcast>[] = [
    ...
    },
    {
        ...
        header: ({ column }) => (
            <div className="flex items-center gap-2">
                ...
                <Button variant="ghost" size="sm" onClick={() => column.toggleSorting(column.getIsSorted() === 'asc')}></Button>
            </div>
        ),
    ...
    },
    {
        ...
        header: 'Description',
        cell: ({ row }) => <div className="line-clamp-2 max-w-xs text-sm text-muted-foreground">{row.getValue('description')}</div>,
    },
    {
